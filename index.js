...
const webAppUrl = "https://main--grand-frangipane-8cb305.netlify.app";
const token = '7159722803:AAEaPeR6B_Ba-qwWzQqNGfhzHF_vpcaDKdQ';
...
app.post('/web-data', async (req,res) => {
   const {queruId, products, totalPrice} = req.body;
  try {
